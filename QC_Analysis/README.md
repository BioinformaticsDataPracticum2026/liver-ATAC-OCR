...
| Periodicity Plots | $\color{green}3 \text{ Clear, distinct humps}$ | $\color{green}3 \text{ Clear, distinct humps}$ | $\color{green}3 \text{ Clear, distinct humps}$ | $\color{green}3 \text{ Clear, distinct humps}$ | $\color{yellow}2 \text{ Clear, distinct humps}$ | $\color{yellow}2 \text{ Clear, distinct humps}$ | $\color{yellow}2 \text{ Clear and distinct humps}$ | $\color{yellow}2 \text{ Clear and distinct humps}$ |
| TSS-Enrichment Score | $\color{red}7.692382151686117$ | $\color{red}7.354598361825624$ | $\color{green}23.294805448649445$ | $\color{green}20.962438980086663$ | $\color{green}18.365117628803656$ | $\color{green}18.997852749462098$ | $\color{green}26.084253634636482$ | $\color{green}14.011771178374902$ |
